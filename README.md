...
**현재 버전: v0.2.0 (한글 출력 엔진 완성, 번역 착수 전)**
...
| 대사 속 숫자 | 원본 8x8 숫자 타일 유지 |
| 메뉴 항목, 팀 선택, 능력치 화면 (미리 그려진 타일맵) | **일본어 원본 유지**, v0.3 이후 |
| 경기 중 HUD, 선수 명단 (8x8 폰트 직접 사용) | **일본어 원본 유지** |
| 타이틀 로고, 그림 문자 | 미착수 |

번역은 `translations/strings.csv`의 `korean` 열에 적습니다. 현재는 동작 확인용으로 18줄만 채워져 있습니다.
